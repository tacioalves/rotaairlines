  ...
  <div class="container">
    ...
    <div class="card-header">
      ...
      <form type="submit"  method="post" action="../controller/UsuarioController.php">
        ...
        <div class="form-check">
          <input class="form-check-input" type="radio" name="genero" value="Masculino" id="radioMasculino" value="M">
          <label class="form-check-label" for="radioMasculino">Masculino</label>
        </div>
        <div class="form-check">
          <input class="form-check-input" type="radio" name="genero" value="Feminino" id="radioFeminino" value="F">
          <label class="form-check-label" for="radioFeminino">Feminino</label>
        </div>
        <div class="form-check">
          <input class="form-check-input" type="radio" name="genero" value="outros" id="radioOutros" value="O">
          <label class="form-check-label" for="radioOutros">Outros</label>
        </div>
    ...
    <div class="card-footer">
      <div class="text-center">
        Já possui uma conta? <a href="login.html" style="color: #026773;">Faça login</a>
      </div>
    </div>
    </form>
