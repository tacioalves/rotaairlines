...
<body>
    ...
    <?php for ($cont = 0; $cont < count($voo->getListaVoosIda()); $cont++) { ?>
      <div class="card">
        <div class="card-body">
          <div class="row">
            <div class="col">
              <img src="<?php echo $voo->getListaVoosIda()[$cont]->getImagem(); ?>"
            ...
            <div class="col">
              <p>
                De:
              <h4>
                <?php echo $voo->getListaVoosIda()[$cont]->getOrigemVoo(); ?>
              </h4>Para:
              <h4>
                <?php echo $voo->getListaVoosIda()[$cont]->getDestinoVoo(); ?>
              </h4>
              </p>
              <p>Vôo
                <?php echo $voo->getListaVoosIda()[$cont]->getClasseVoo(); ?>
              </p>
              <p style="font-weight: bold">Valor: R$
                <?php echo $voo->getListaVoosIda()[$cont]->getValorVoo(); ?>
              </p>
            </div>
            <div class="col">
              <h5 stylAF e="margin-top: 0; margin-bottom: 0.5em;">Data/Hora</h5>
              <p style="font-weight: bold">
                <?php echo $voo->getListaVoosIda()[$cont]->getDataHoraPartida(); ?>
              </p>
            </div>
            <div class="col" style="text-align: center;">
              <br><br>
              <input type="radio" id="ida<?php echo $cont; ?>" name="voo_ida"
                value="<?php echo $voo->getListaVoosIda()[$cont]->getIdVoo(); ?>"><strong> Selecionar</strong></input>
            </div>
          </div>
        </div>
      </div>
  ...
  <div class="container">
    <?php if (count($voo->getListaVoosVolta()) >= 1) { ?>
      <br>
      <h2>Vôos de volta disponíveis para data selecionada:</h2>
      <br>
      <?php for ($cont = 0; $cont < count($voo->getListaVoosVolta()); $cont++) { ?>
        <div class="card">
          <div class="card-body">
            <div class="row">
              <div class="col">
                <img src="<?php echo $voo->getListaVoosVolta()[$cont]->getImagem(); ?>"
                  style="width: 300px; border-radius: 10px;">
              </div>
              <div class="col">
                <p>
                  De:
                <h4>
                  <?php echo $voo->getListaVoosVolta()[$cont]->getOrigemVoo(); ?>
                </h4>Para:
                <h4>
                  <?php echo $voo->getListaVoosVolta()[$cont]->getDestinoVoo(); ?>
                </h4>
                </p>
                <p>Vôo
                  <?php echo $voo->getListaVoosVolta()[$cont]->getClasseVoo(); ?>
                </p>
                <p style="font-weight: bold">Valor: R$
                  <?php echo $voo->getListaVoosVolta()[$cont]->getValorVoo(); ?>
                </p>
              </div>
              <div class="col">
                <h5 stylAF e="margin-top: 0; margin-bottom: 0.5em;">Data/Hora</h5>
                <p style="font-weight: bold">
                  <?php echo $voo->getListaVoosVolta()[$cont]->getDataHoraPartida(); ?>
                </p>
              </div>
              <div class="col" style="text-align: center;">
                <br><br>
                <input type="radio" id="volta<?php echo $cont; ?>" name="voo_volta"
                  value="<?php echo $voo->getListaVoosVolta()[$cont]->getIdVoo(); ?>"><strong> Selecionar</strong></input>
              </div>
            </div>
          </div>
        </div>
