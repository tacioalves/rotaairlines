...
<?php include 'view/navbarDinamico.php'; ?>
  ...
  <div class="container">
    ...
    <h5>Codigo da Reserva: <?php echo $voo->getCodigoReserva()?> </h5><br>
    ...
    <div class="row" style="border-radius: 20px; background-color: #E3E7FB;">
      <div class="col">
        ...
        <h6><?php echo $voo->getOrigemVoo()?><br><?php echo $voo->getDataHoraPartida()?> </h6>
      ...
      <div class="col">
        ...
        <h6><?php echo $voo->getDestinoVoo()?><br><?php echo $voo->getDataHoraChegada()?> </h6>
        <img src="view/src/aviaoIcone.png" style="width: 60px; float: right; margin-top: -35%; margin-right: 10%;">
      </div>
      <div class="col">
        <h5 style="margin-top: 20px;">Duração</h5><br>
        <h6><?php echo $voo->getDuracao()?></h6><br>
        <img src="view/src/aviaoIcone.png" style="width: 60px; float: right; margin-top: -35%; margin-right: 10%;">
      </div>
      <div class="col">
        <h5 style="margin-top: 20px;">Voo</h5><br>
        <h6><?php echo $voo->getNumVoo()?></h6><br>
      </div>
    </div>
  </div><br><br>
  ...
  <div class="container" style="border-radius: 20px; height: 70px; background-color:lavender;">
    ...
    <div class="row">
      ...
      <div class="col">
        <h5><?php echo $usuario->getNomeUsuario()?></h5>
      </div>
      <?php if($validaCheckin->getValidaCheckin()==1){?>
      <div class="col">
...
<div class="container">
  ...
  <div class="row">
    <div class="col-sm-6">
      ...
      <h5><a>Seu Assento foi escolhido <br>automaticamente:</a> <?php echo $validaCheckin->getAssentoReservado()?><h5>
    </div>
    <div class="col-sm-6">
  ...
  <div class="container cartaoEmbarque">
    <div class="row">
      <div class="col-sm-3">
        <h4><?php echo $usuario->getNomeUsuario()?></h4>
      ...
      <div class="col-sm-3">
        <h5>Origem</h5>
        <h5 style="font-weight: bold;"><?php echo $voo->getOrigemVoo()?></h5>
        <h5 style="margin-top: 30px;">Data</h5>
        <h5 style="font-weight: bold;"><?php echo $voo->getDataHoraPartida()?></h5>
        <h5 style="margin-top: 30px;">Numero do Voo</h5>
        <h5 style="font-weight: bold;"><?php echo $voo->getNumVoo()?></h5>
      ...
      <div class="col-sm-3">
        <h5>Destino</h5>
        <h5 style="font-weight: bold;"><?php echo $voo->getDestinoVoo()?><br><?php echo $voo->getDataHoraChegada()?></h5>
        <h5 style="margin-top: 30px;">Operado Por</h5>
        <h5 style="font-weight: bold;">ROTA AIRLINES</h5>
        <h5 style="margin-top: 30px;">Assento</h5>
        <h5 style="font-weight: bold;"><?php echo $validaCheckin->getAssentoReservado()?></h5>
